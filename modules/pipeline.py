...
# настройка логирования, чтобы видеть вывод в консоли
logging.basicConfig(level=logging.INFO)

# абсолютный путь по умолчанию, чтобы избежать ошибок с "data/train/homework.csv"
...
def pipeline() -> None:
    ...
    # замена параметров моделей для стабильной работы
    models = [
